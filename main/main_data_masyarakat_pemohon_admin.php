...
<?php
      ...
      <td><?php echo $d['id']; ?></td>
        ...
        <td><button type="button" class="btn btn-primary btn-rounded" ><a class="btn btn-link" style="color: #ffffff;" href="../index/idx_cek_pemohon_admin.php?id1=<?php echo $d['rt']; ?>">Konfirmasi</a></button></td>	
        </tr>
      <tbody>
     <?php
    }
