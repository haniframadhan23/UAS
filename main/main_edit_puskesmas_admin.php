...
<form action="../proses/proses_edit_puskesmas.php" method="post">
  <!-- Grid row -->
  <div class="form-row">
  <!-- Default input -->
  <div class="form-group col-md-1">
    ...
    <div class="form-group col-md-2">
      ...
      <input type="text" class="form-control" id="namapuskesmas" placeholder="Masukan Nama Puskesmas" name="namapuskesmas"  value="<?php echo $d['nama_Puskesmas'] ?>">
    </div>
    <!-- Default input -->
 ...
 <div class="form-row">
    ...
    <div class="form-group col-md-2">
      ...
      <input type="text" class="form-control" id="bantuanapd" name="bantuanapd" placeholder="Masukan Jumlah APD"  value="<?php echo $d['bantuan_apd'] ?>">
    </div>
    <div class="form-group col-md-3">
